...
def restaurant_service_policy_config() -> DetectionPolicyConfig:
    return DetectionPolicyConfig(
        ...
        rules=(
            ...
            ClassDetectionRule("plate", confidence_threshold=0.28, min_hits=2, window_size=4),
            ClassDetectionRule("plate_empty", confidence_threshold=0.30, min_hits=3, window_size=5),
            ClassDetectionRule("plate_full", confidence_threshold=0.30, min_hits=3, window_size=5),
